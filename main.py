...
class calculate():
    ...
    def __init__(self):
        ...
        self.button1.grid(row=1,column=1, padx=3, pady=3)
        ...
        self.button2.grid(row=1, column=2, padx=3, pady=3)
        ...
        self.button3.grid(row=1, column=3, padx=3, pady=3)
        ...
        self.button4.grid(row=2, column=1, padx=3, pady=3)
        ...
        self.button5.grid(row=2, column=2, padx=3, pady=3)
        ...
        self.button6.grid(row=2, column=3, padx=3, pady=3)
        ...
        self.button8.grid(row=3, column=2, padx=3, pady=3)
        ...
        self.button9.grid(row=3, column=3, padx=3, pady=3)
        ...
        self.button_open.grid(row=4, column=4, padx=3, pady=3)
        ...
        self.button_close.grid(row=4, column=5, padx=3, pady=3)
        ...
        self.buttonmultiply.grid(row=3, column=0, padx=3, pady=3)
        ...
        self.buttondivide.grid(row=4, column=0, padx=3, pady=3)
        ...
        # Special Buttons
        self.buttonclear = Button(self.root, text="Clr", width=3, command=lambda: self.cancel(),relief=RAISED,bg='#EF5350',fg='white')
        self.buttonclear.grid(row=4, column=1, padx=3, pady=3)
        self.buttonclear.config(font=("Arial", 25))

        self.buttondeleteall = Button(self.root, text="Del", width=3, command=lambda: self.delete_all(),relief=RAISED)
        self.buttondeleteall.grid(row=4, column=3, padx=3, pady=3)
        ...
        self.buttonresult.grid(row=4, column=6, padx=3, pady=3, columnspan=2)
